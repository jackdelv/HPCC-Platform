...
Write(simpleDataset, '/home/hpccuser/dev/parquet-legacy/test_data/simple.parquet');

read_in := Read(simpleRec, '/home/hpccuser/dev/parquet-legacy/test_data/simple.parquet');
